...
export function LoopMark({ href = "/", light = false }: { href?: string; light?: boolean }) {
  return (
    <Link href={href} className="inline-flex items-center gap-2.5 no-underline">
      <span className="relative flex h-8 w-8 items-center justify-center rounded-[9px] bg-[#635BFF] shadow-[0_1px_2px_rgba(99,91,255,0.45)]">
